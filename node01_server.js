/*
	nodejs는 이벤트기반 비동기식 서버프레임워크이다.
	
	===== 준비사항 ==================
	1. http://www.nodejs.org에서 다운로드 후 설치한다.
	   cmd에서 node -v으로 버젼을 확인할수 있다.
    2. 이클립스에서  node 설치
       help-> eclipse Marketplace -> node검색 후
       Enide.p2f - Eclipse Node.js IDE.17.plus를 Install한다.
*/

//1. 서버를 생성하기 위해서는 http모듈이 필요하다.
